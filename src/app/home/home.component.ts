...
export class HomeComponent implements OnInit, OnDestroy {
    ...
    private scrollToBottom(attempt = 0): void {
        ...
        if (this.isComposeMode) {
            void this.onComposeTargetSubmit().then(() => {
                if (!this.composeResolvedTarget) {
                    this.errorMessage =
                        'Bitte zuerst einen gültigen Empfänger über #channel oder @name auswählen.';
                    return;
                }
    ...
    // =========================================================
    // Message Display / Tracking / Editing
    // =========================================================
    ...
    // =========================================================
    // Message Grouping / Sorting / Date Helpers
    // =========================================================

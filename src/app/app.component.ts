...
export class AppComponent {
    ...
    constructor(
        ...
        console.log(
            '[INIT] AppComponent constructor - showAuthScreen:',
            this.showAuthScreen,
        );
        ...
        this.authService.currentUser$.subscribe((user) => {
            console.log(
                '[AUTH STATE] User changed:',
                user?.email ?? 'null (not logged in)',
            );
            console.log(
                '[AUTH STATE] Current showAuthScreen:',
                this.showAuthScreen,
            );
            ...
            if (user && isOnProtectedRoute) {
                console.log(
                    '[AUTH STATE] User authenticated + on protected route → hiding auth screen',
                );
                this.showAuthScreen = false;
            } else {
                console.log(
                    '[AUTH STATE] User NOT authenticated or on auth route → showing auth screen',
                );
